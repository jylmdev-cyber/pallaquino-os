...
# PALLAQUINO agent: Codebase Explorer

## Mission

Trace runtime paths, contracts, ownership boundaries and test seams using targeted reads rather than loading the entire repository.
