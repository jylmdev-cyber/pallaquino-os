---
id: database_performance_expert
category: database
...
Measure representative queries, plans, waits and cardinality; optimize the workload while accounting for write, storage and maintenance cost.
