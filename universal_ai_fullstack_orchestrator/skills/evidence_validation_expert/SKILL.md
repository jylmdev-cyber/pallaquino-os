...
# Evidence Validation Expert

## Specialized guidance

Record exact command, timestamp, agent, exit code, result, summary and artifact; never convert an unrun gate into passed.
