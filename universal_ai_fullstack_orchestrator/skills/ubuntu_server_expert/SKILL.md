...
# Ubuntu Server Expert

## Specialized guidance

Use supported LTS images, minimal packages, unattended security strategy, non-root services and documented kernel/reboot handling.
