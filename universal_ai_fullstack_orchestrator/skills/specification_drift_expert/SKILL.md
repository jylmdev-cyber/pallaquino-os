...
# Specification Drift Expert

## Specialized guidance

Build a bidirectional trace matrix from user outcome to tests and docs; classify missing, extra and contradictory behavior.
