...
# Adversarial Review Expert

## Specialized guidance

Probe malformed inputs, boundary values, concurrency, retries, partial failure, privilege changes and data-integrity invariants.
