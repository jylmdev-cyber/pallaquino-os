...
Separate server/client boundaries, use composables deliberately, protect hydration and SEO, and verify the stable supported Nuxt release before scaffolding.
