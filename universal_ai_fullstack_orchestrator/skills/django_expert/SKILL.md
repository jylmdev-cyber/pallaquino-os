...
Keep views thin, domain rules explicit and queries bounded; use Django migrations and authorization primitives while verifying the selected supported version.
