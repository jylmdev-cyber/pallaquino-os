...
# Outbox Pattern Expert

## Specialized guidance

Atomically persist domain change and event intent, then publish idempotently with monitoring, cleanup and replay controls.
